...
class LeNet(nn.Module):
    ...
    def __init__(self):
        ...
        self.convnet=nn.Sequential(nn.Conv2d(3, 6, 5),nn.BatchNorm2d(6),nn.ReLU(),nn.MaxPool2d(2,2),nn.Conv2d(6, 16, 5),nn.BatchNorm2d(16),nn.ReLU(),nn.MaxPool2d(2,2),nn.Conv2d(16, 120, 5),nn.BatchNorm2d(120),nn.ReLU())        
        #Sequential Model for the Fully Connected Layers ahead of the Convolution Part
        self.fc=nn.Sequential(nn.Linear(120,84),nn.BatchNorm1d(84),nn.ReLU(),nn.Linear(84,10),nn.BatchNorm1d(10),nn.LogSoftmax(dim=-1))
