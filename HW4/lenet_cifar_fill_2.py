...
class LeNet(nn.Module):
    ...
    def __init__(self):
        ...
        self.convnet=nn.Sequential(nn.Conv2d(3, 6, 5),nn.Dropout(0.3),nn.ReLU(),nn.MaxPool2d(2,2),nn.Conv2d(6, 16, 5),nn.ReLU(),nn.MaxPool2d(2,2),nn.Conv2d(16, 120, 5),nn.ReLU())        
        #Sequential Model for the Fully Connected Layers ahead of the Convolution Part
        self.fc=nn.Sequential(nn.Linear(120,84),nn.Dropout(0.5),nn.ReLU(),nn.Linear(84,10),nn.LogSoftmax(dim=-1))
